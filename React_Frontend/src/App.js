        ...
        <div className="main-body">
          ...
          <Container>
            ...
            <p>
              ...
              we believe our metrics provide a useful "signal" for helping you decide the accuracy of a piece of news content.  Moreover, it is crucial to 
              understand that when discussing the GPT-2 output detector, the phrases “fake text” and “real text” strictly refer to whether the text was 
              generated by a machine or by a human and do not refer to whether the text’s content is true or false. As such, the GPT-2 output detector 
              does not make a direct claim about the veracity of a piece of content. There are cases in which a language model produces a true sentence, 
              and there are also cases in which a human writes a false statement. We chose to include the GPT-2 output detector in our platform because 
              we believe that, while being machine generated is not the same as being false, knowing whether a piece of content is likely to be machine 
              generated may help gauge credibility.
